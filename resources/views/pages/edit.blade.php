...
@section('content')
    <div class="grid gap-2 justify-center mb-5">
        <h2 class="bg-slate-700 text-white text-xl text-center p-2 my-3 border border-solid border-black shadow">Edit Product</h2>
        <form>
            @csrf
            ...
            <span><button class="bg-blue-300 p-2 w-full my-3 rounded shadow-md shadow-slate-600">UPDATE</button></span>
        </form>
    </div>   
@endsection